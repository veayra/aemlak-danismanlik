    ...
    <div style={s.outer}>
      <div style={s.page}>
        ...
        <div style={s.content}>
          ...
          {canEdit && (
            <button onClick={() => navigate(`/ilan/${id}/duzenle`)}
              style={{...s.deleteBtn, background:'#f5f4f0', color:'#555', border:'1px solid #e0ddd8', marginBottom:8}}>
              ✏️ İlanı Düzenle
            </button>
          )}
...
const s = {
  ...
  deleteBtn: { width:'100%', padding:13, border:'1px solid #fbd5c8', borderRadius:12, background:'#fef0ed', color:'#c8410a', cursor:'pointer', fontSize:14, marginBottom:0 }
}
