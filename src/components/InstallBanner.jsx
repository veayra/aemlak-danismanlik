  ...
  return (
    <div style={s.banner}>
      ...
      <div style={s.text}>
        ...
        <p style={s.sub}>
          {isIOS
            ? 'Paylaş → "Ana Ekrana Ekle" tıklayın'
      ...
      <div style={s.actions}>
        {!isIOS && (
          <button onClick={handleInstall} style={s.installBtn}>Ekle</button>
        )}
...
const s = {
  banner: {
    position: 'fixed', bottom: 70, left: 12, right: 12, zIndex: 300,
  ...
  sub: { fontSize: 12, color: '#777', lineHeight: 1.4 },
  actions: { display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 },
  installBtn: {
    background: '#ff3b5c', color: '#fff', border: 'none',
